    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex">          
                ...
                <!-- <img src="C:\Users\anura\Desktop\team.jpg" style="width: 15px; height: 15px;"> -->
                <?php
            ...
            <form id="login-form">
                ...
                <div class="modal-body">                         
                    <div class="mb-3">
                        ...
                        <input type="text" name="email_username" class="form-control shadow-none" required> 
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <button type="button" class="btn text-secondary text-decoration-none shadow-none pe-0 me-0" data-bs-toggle="modal" data-bs-target="#forgotModal" data-bs-dismiss="modal">
                            Forgot Password?                    
                        </button>
                    </div>
        ...
        <div class="modal-content">
            <form id="forgot-form">
                ...
                <div class="modal-body">                         
                    <div class="mb-4">
                        <span class="badge bg-light text-dark mb-3 text-wrap lh-base">
                            Note: A link will send to your email to reset your password!                                                        
                        </span>
                    ...
                    <div class="mb-2 text-end">
                        ...
                        <button type="submit" name="login" class="btn btn-dark shadow-none">Send Link</button>
                    </div>
