    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="modal fade" id="general-setting" data-bs-backdrop="static" 
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="site_about" class="form-control shadow-none" id = 'site_about_input' rows="6" required></textarea>
                                    </div>                                    
                ...
                <div class="modal fade" id="contacts-s" data-bs-backdrop="static" 
                    data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                <div class="modal fade" id="team-s" data-bs-backdrop="static" 
                    data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form id='team_s_form'>
                            <div class="modal-content">
